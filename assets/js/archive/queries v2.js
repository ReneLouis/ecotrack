...
const summary = async (request, response) => {
  ...
  const 
  */
  const loadVehicleDetails = (request, response) => {
    pool.query(
  ...
  const loadFuelData = () => {
    // const vehicleDetails = await loadVehicleDetails();
    pool.query(
      ...
      (error, result) => {
        ...
        // console.log(result.rows);
        console.log(
          `INSIDE 'loadOverallFuelData' function. Quantity: ${quantityTotal} ; distance: ${distanceTotal}`
        );
        ...
        // console.log(
        //   `OUTSIDE 'loadOverallFuelData' function. Quantity: ${quantityTotal} ; distance: ${distanceTotal}`
        // );
        ...
        pool.query(
          ...
          (error, result) => {
            ...
            if (result.rowCount > 0) {
              ...
              // ====================================================== //
              // ======= RENDER PAGE WITH NO FUEL DATE Render Page ======/
              response.render("layout", {
